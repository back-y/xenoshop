<center><!-- center begin -->
    ...
    If you have any questions, feel free to <a href="../contact.php"> Contact Us</a>. Our Customer works <strong>24/7</strong>
...
<div class="table-responsive"><!-- table-responsive begin -->
    ...
    <table class="table table-bordered table-hover table-striped"> <!-- table table-bordered table-hover begin -->
        ...
        <tbody><!-- tbody begin -->
            ...
            <td> NIC #980-231-907 | Mobile No: +2519-7303-3007 | Name: MrBereket </td>
            <td> Real Name: Mr Bereket | Mobile No: +2519-7303-3007 | Country: Ethiopia | Name: MrBereket | NIC #980-231-907 </td>
