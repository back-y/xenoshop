                        ...
                        <div class="form-group"><!-- form-group begin -->
                            ...
                            <div class="col-md-6"><!-- col-md-6 begin -->
                                ...
                                <select name="manufacturer"  class="form-control"><!-- form-control begin -->
                                    ...
                                    <option selected value="<?php echo $manufacturer_id; ?>"> <?php echo 
                            ...
                            <div class="col-md-6"><!-- col-md-6 begin -->
                                ...
                                <div class="tab-content"> <!-- tab-content begin -->
                                    ...
                                    <div class="tab-pane fade in" id="features"><!-- tab-panel fade in active begin -->
                                        ...
                                        <textarea name="product_features" id="features_editor" cols="30" rows="10" class="form-control">
                                    ...
                                    <div class="tab-pane fade in" id="videos"><!-- tab-panel fade in active begin -->
                                        ...
                                        <textarea name="product_video" id="videos" cols="30" rows="10" class="form-control">
...
<?php
    ...
    if(isset($_POST['update'])){
        ...
        date=NOW(),product_title='$product_title',product_url='$product_url',product_img1='$product_img1',product_img2='$product_img2',
        product_img3='$product_img3',product_keywords='$product_keywords',
        product_desc='$product_desc',product_features='$product_features',product_video='$product_video',product_label='$product_label',product_sale='$product_sale',product_price='$product_price' where product_id='$p_id'";
        ...
        $update_product = "update products set p_cat_id='$product_cat',cat_id='$cat',manufacturer_id='$manufacturer_id',
        date=NOW(),product_title='$product_title',product_url='$product_url',product_keywords='$product_keywords'
        ,product_desc='$product_desc',product_features='$product_features',product_video='$product_video'
        ,product_sale='$product_sale',product_label='$product_label',product_price='$product_price' where product_id='$p_id'";
